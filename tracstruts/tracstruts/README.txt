Trac Struts - Part of the Test Manager plugin for Trac
...
A Trac plugin to help develop MVC based Trac plugins.
...
Release 1.0.0 (2015-08-01):
  o First release publicly available, as part of the Test Manager plugin
