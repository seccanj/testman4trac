...
trac_project_url = "http://anonymous@localhost:8000/test02/rpc"
...
sub_cat = server.testmanager.createTestCatalog(root_cat, "Test Sub-Catalog RPC", "This is a wonderful sub-catalog.", {'remarks': 'Remarks are Ciao core de mamma'})
print sub_cat

print ">> Creating two test cases in the root catalog"
tc_1 = server.testmanager.createTestCase(root_cat, "Test Case 1", "This is a wonderful test case.", {'component': 'GUI'})
print tc_1
...
tplan = server.testmanager.createTestPlan(root_cat, "Test Root Plan RPC", {'longdescription': 'Ciao core de mamma'})
print tplan
...
print server.testmanager.modifyTestObject('testcaseinplan', tc_1, {'planid': tplan, 'operating_system': "Macosx"})

print ">> Getting first test case in plan properties"
for v in server.testmanager.getTestCase(tc_1, tplan):
    print v
