...
The Test Manager functionality is split up into four plugins:
    ...
    TracStruts:
        ...
        This module provides a framework to help build MVC based 
        Trac plugins. It resembles the Apache Struts framework for the
        Java environment.
    ...
    TestManager:
        ...
        Features:
            ...
            * Python API.
            * Command Line interface: "tm-admin"
